...
kbl(tabela, 
    caption = "Analiza statystyczna wydatków w podziale na lokalizacje",
    booktabs = TRUE, 
    align = "c") %>%
  kable_styling(
  ...
  column_spec(1, bold = TRUE, border_right = TRUE) %>% # Wyróżnienie nazw statystyk
  add_header_above(c(" " = 1, "Lokalizacje" = ncol(tabela)))
```

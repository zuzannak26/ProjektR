...
Przeprowadzona analiza wykazała, że w badanym zbiorze danych występuje **`r n_miss(dane)`** **obserwacji** zawierających braki danych, co stanowi **`r round(pct_miss(dane),2)`%** wszystkich obserwacji, natomiast **`r n_complete(dane)`** **obserwacji** stanowią dane kompletne.
